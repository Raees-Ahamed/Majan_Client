...
import { clientId } from "../../AppHelp/AppGlobal";
...
const NavigationHeader = (props) => {
  ...
  const [cookies, removeCookie] = useCookies(["jwtToken","jwtTokenGoogle"]);
      ...
      >
        <Toolbar className={classes.toolbar}>
          ...
          <nav>
            ...
            {cookies.jwtTokenGoogle !== 'undefined' ? (
              <GoogleLogout
                clientId={clientId}
                buttonText="Logout"
            ...
            {cookies.jwtToken !== "undefined" ? (
              <label onClick={() => logoutNormal()}>Logout</label>
            ) : (
              <label></label>
            )}
          </nav>
