...
const GridItems = (props) =>{
    ...
    const filterItems = (searchString) => {
        ...
        copyOfCurrentItems.map(product => {
            ...
            if(productName.includes(searchingString) || productDesc.includes(searchingString)){
    ...
    useEffect(() => {
        if(categoryId == null){
            ...
            axios.get(AppGlobal.apiBaseUrl + `ProductCategory/${categoryId}`).then(function (response) {
                console.log(response.data);
                setItems({products: response.data});
            })
        }
    ...
    if(getTemporaryItems.products == "Empty data"){
        gridItems = <Container maxWidth={false} style={{'alignItems': 'center'}}><Alert color="warning" severity="info" style={{'fontSize':'14px','marginTop':'20px','fontWeight':'bold'}}>Sorry ! The item you are looking for not found.</Alert></Container>;
                    ...
                    <Card className={classes.card}>
                        ...
                        <CardContent className={classes.cardContent}>
                            ...
                            <Typography>
                                ...
                                <br />
                                <br />
                                Unit Price: <NumberFormat value={product.unitPrice} displayType={'text'} thousandSeparator={true} prefix={'Rs '} />
                                <br />
                                <br />
